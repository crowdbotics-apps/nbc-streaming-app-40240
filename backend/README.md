...
## Project Structure
    ...
    ├── nbc_universal_studi_40240  # Django project configurations
...
1. Clone this repo and `cd nbc_universal_studi_40240`
...
2. Clone this repo and `cd nbc_universal_studi_40240`
